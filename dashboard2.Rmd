...
int_box = noaa_long_00_10 %>%
  ...
  layout(xaxis = list(title = "Month"),
         ...
         title = "Range of Maximum Temperature in New York (2000-2010)")
int_box
...
snow_plot = snow_djf %>%
  ...
  layout(xaxis = list(title = "Month"),
         ...
         title = "Average Monthly Snowfall in New York (2000-2010)")
snow_plot
```
...
precip_bar = precipitation %>%
  ...
  layout(xaxis = list(title = "Month"),
         ...
         title = "New York Average Monthly Precipitation (2000-2010)")
precip_bar
```
